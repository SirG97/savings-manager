...
export default function CustomerDeductCommission() {
      ...
      <div className="space-y-10 divide-y divide-gray-900/10">
        ...
        <div className="grid grid-cols-1 gap-x-8 gap-y-8 pt-10 md:grid-cols-3">
          <div className="px-4 sm:px-0">
            <h2 className="text-base/7 font-semibold text-gray-900">Commission</h2>
            <p className="mt-1 text-sm/6 text-gray-600">
              Enter the amount you want to deduct as commission earned. All fields
              marked asterisk(*) are required
            </p>
          </div>

          <form
            onSubmit={handleSubmit(handleDeductCommission)}
