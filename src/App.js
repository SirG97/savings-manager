  ...
  return (
    <>
      <Routes>
        ...
        <Route
          exact
          path="/customer/:id/deposit"
          element={<CustomerDeposit />}
        />
        <Route
          exact
          path="/customer/:id/withdraw"
        ...
        <Route
          exact
          path="/loan-applications/pending"
          element={<LoanApplication />}
        />
        <Route
          exact
          path="/loan-applications/approved"
          element={<LoanApplication />}
        />
        <Route
          exact
          path="/loan-applications/rejected"
          element={<LoanApplication />}
        />
        <Route
          exact
          path="/loan-applications/due"
          element={<LoanApplication />}
        />
        <Route
          exact
          path="/loan-applications/overdue"
          element={<LoanApplication />}
        />
        <Route
          exact
          path="/loan-applications/completed"
          element={<LoanApplication />}
        />
